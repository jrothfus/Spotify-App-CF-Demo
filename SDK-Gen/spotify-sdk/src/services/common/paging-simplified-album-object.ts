...
/**
 * Zod schema for the PagingSimplifiedAlbumObject model.
 * Defines the structure and validation rules for this data type.
 * This is the shape used in application code - what developers interact with.
 */
export const pagingSimplifiedAlbumObject = z.lazy(() => {
  return z.object({
    href: z.string(),
    limit: z.number(),
    ...
    total: z.number(),
    items: z.array(simplifiedAlbumObject),
  });
});

/**
 * 
 * @typedef  {PagingSimplifiedAlbumObject} pagingSimplifiedAlbumObject   
...
/**
 * Zod schema for mapping API responses to the PagingSimplifiedAlbumObject application shape.
 * Handles any property name transformations from the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const pagingSimplifiedAlbumObjectResponse = z.lazy(() => {
  return z
    .object({
      href: z.string(),
      limit: z.number(),
      ...
      previous: z.string().nullable(),
      total: z.number(),
      items: z.array(simplifiedAlbumObjectResponse),
    })
    .transform((data) => ({
      href: data['href'],
      limit: data['limit'],
...
/**
 * Zod schema for mapping the PagingSimplifiedAlbumObject application shape to API requests.
 * Handles any property name transformations required by the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const pagingSimplifiedAlbumObjectRequest = z.lazy(() => {
  return z
    .object({
      href: z.string(),
      limit: z.number(),
      ...
      previous: z.string().nullable(),
      total: z.number(),
      items: z.array(simplifiedAlbumObjectRequest),
    })
    .transform((data) => ({
      href: data['href'],
      limit: data['limit'],
