...
} from './simplified-audiobook-object';

/**
 * Zod schema for the PagingSimplifiedAudiobookObject model.
 * Defines the structure and validation rules for this data type.
 * This is the shape used in application code - what developers interact with.
 */
export const pagingSimplifiedAudiobookObject = z.lazy(() => {
  return z.object({
    href: z.string(),
    limit: z.number(),
    ...
    total: z.number(),
    items: z.array(simplifiedAudiobookObject),
  });
});

/**
 * 
 * @typedef  {PagingSimplifiedAudiobookObject} pagingSimplifiedAudiobookObject   
...
/**
 * Zod schema for mapping API responses to the PagingSimplifiedAudiobookObject application shape.
 * Handles any property name transformations from the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const pagingSimplifiedAudiobookObjectResponse = z.lazy(() => {
  return z
    .object({
      href: z.string(),
      limit: z.number(),
      ...
      previous: z.string().nullable(),
      total: z.number(),
      items: z.array(simplifiedAudiobookObjectResponse),
    })
    .transform((data) => ({
      href: data['href'],
      limit: data['limit'],
...
/**
 * Zod schema for mapping the PagingSimplifiedAudiobookObject application shape to API requests.
 * Handles any property name transformations required by the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const pagingSimplifiedAudiobookObjectRequest = z.lazy(() => {
  return z
    .object({
      href: z.string(),
      limit: z.number(),
      ...
      previous: z.string().nullable(),
      total: z.number(),
      items: z.array(simplifiedAudiobookObjectRequest),
    })
    .transform((data) => ({
      href: data['href'],
      limit: data['limit'],
