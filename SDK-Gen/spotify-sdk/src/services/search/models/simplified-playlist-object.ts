...
import {
  ...
  playlistTracksRefObject,
  playlistTracksRefObjectRequest,
  playlistTracksRefObjectResponse,
} from './playlist-tracks-ref-object';

/**
 * Zod schema for the SimplifiedPlaylistObject model.
 * Defines the structure and validation rules for this data type.
 * This is the shape used in application code - what developers interact with.
 */
export const simplifiedPlaylistObject = z.lazy(() => {
  return z.object({
    ...
    items: playlistTracksRefObject.optional(),
...
/**
 * 
 * @typedef  {SimplifiedPlaylistObject} simplifiedPlaylistObject   
 ...
 * @property {PlaylistTracksRefObject} 
 * @property {PlaylistTracksRefObject} 
...
/**
 * Zod schema for mapping API responses to the SimplifiedPlaylistObject application shape.
 * Handles any property name transformations from the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const simplifiedPlaylistObjectResponse = z.lazy(() => {
  return z
    .object({
      collaborative: z.boolean().optional(),
      description: z.string().optional(),
      ...
      items: playlistTracksRefObjectResponse.optional(),
      tracks: playlistTracksRefObjectResponse.optional(),
      type: z.string().optional(),
      uri: z.string().optional(),
    })
    .transform((data) => ({
...
/**
 * Zod schema for mapping the SimplifiedPlaylistObject application shape to API requests.
 * Handles any property name transformations required by the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const simplifiedPlaylistObjectRequest = z.lazy(() => {
  return z
    .object({
      collaborative: z.boolean().optional(),
      description: z.string().optional(),
      ...
      public: z.boolean().optional(),
      snapshotId: z.string().optional(),
      items: playlistTracksRefObjectRequest.optional(),
      tracks: playlistTracksRefObjectRequest.optional(),
      type: z.string().optional(),
      uri: z.string().optional(),
    })
    .transform((data) => ({
