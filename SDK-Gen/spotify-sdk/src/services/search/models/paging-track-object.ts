...
/**
 * Zod schema for the PagingTrackObject model.
 * Defines the structure and validation rules for this data type.
 * This is the shape used in application code - what developers interact with.
 */
export const pagingTrackObject = z.lazy(() => {
  return z.object({
    href: z.string(),
    limit: z.number(),
    ...
    total: z.number(),
    items: z.array(trackObject),
  });
});

/**
 * 
 * @typedef  {PagingTrackObject} pagingTrackObject   
...
/**
 * Zod schema for mapping API responses to the PagingTrackObject application shape.
 * Handles any property name transformations from the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const pagingTrackObjectResponse = z.lazy(() => {
  return z
    .object({
      href: z.string(),
      limit: z.number(),
      ...
      previous: z.string().nullable(),
      total: z.number(),
      items: z.array(trackObjectResponse),
    })
    .transform((data) => ({
      href: data['href'],
      limit: data['limit'],
...
/**
 * Zod schema for mapping the PagingTrackObject application shape to API requests.
 * Handles any property name transformations required by the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const pagingTrackObjectRequest = z.lazy(() => {
  return z
    .object({
      href: z.string(),
      limit: z.number(),
      ...
      previous: z.string().nullable(),
      total: z.number(),
      items: z.array(trackObjectRequest),
    })
    .transform((data) => ({
      href: data['href'],
      limit: data['limit'],
