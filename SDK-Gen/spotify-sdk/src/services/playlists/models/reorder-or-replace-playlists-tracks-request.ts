...
/**
 * Zod schema for the ReorderOrReplacePlaylistsTracksRequest model.
 * Defines the structure and validation rules for this data type.
 * This is the shape used in application code - what developers interact with.
 */
export const reorderOrReplacePlaylistsTracksRequest = z.lazy(() => {
  return z.object({
...
/**
 * 
 * @typedef  {ReorderOrReplacePlaylistsTracksRequest} reorderOrReplacePlaylistsTracksRequest   
 * @property {string[]} 
 ...
 */
export type ReorderOrReplacePlaylistsTracksRequest = z.infer<
  typeof reorderOrReplacePlaylistsTracksRequest
>;

/**
 * Zod schema for mapping API responses to the ReorderOrReplacePlaylistsTracksRequest application shape.
 * Handles any property name transformations from the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const reorderOrReplacePlaylistsTracksRequestResponse = z.lazy(() => {
  return z
    .object({
      uris: z.array(z.string()).optional(),
...
/**
 * Zod schema for mapping the ReorderOrReplacePlaylistsTracksRequest application shape to API requests.
 * Handles any property name transformations required by the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const reorderOrReplacePlaylistsTracksRequestRequest = z.lazy(() => {
  return z
    .object({
      uris: z.array(z.string()).optional(),
      rangeStart: z.number().optional(),
