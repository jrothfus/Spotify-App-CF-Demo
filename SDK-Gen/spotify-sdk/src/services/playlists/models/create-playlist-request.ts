...
/**
 * Zod schema for the CreatePlaylistRequest model.
 * Defines the structure and validation rules for this data type.
 * This is the shape used in application code - what developers interact with.
 */
export const createPlaylistRequest = z.lazy(() => {
  return z.object({
    name: z.string(),
...
/**
 * 
 * @typedef  {CreatePlaylistRequest} createPlaylistRequest   
...
/**
 * Zod schema for mapping API responses to the CreatePlaylistRequest application shape.
 * Handles any property name transformations from the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const createPlaylistRequestResponse = z.lazy(() => {
  return z
    .object({
      name: z.string(),
      public: z.boolean().optional(),
...
/**
 * Zod schema for mapping the CreatePlaylistRequest application shape to API requests.
 * Handles any property name transformations required by the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const createPlaylistRequestRequest = z.lazy(() => {
  return z
    .object({
      name: z.string(),
      public: z.boolean().optional(),
