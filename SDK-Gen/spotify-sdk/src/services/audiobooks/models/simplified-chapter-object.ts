...
import {
  ...
  simplifiedChapterObjectReleaseDatePrecision,
} from './simplified-chapter-object-release-date-precision';
import {
  ResumePointObject,
  resumePointObject,
...
import {
  ...
  simplifiedChapterObjectType,
} from './simplified-chapter-object-type';
import {
...
/**
 * Zod schema for the SimplifiedChapterObject model.
 * Defines the structure and validation rules for this data type.
 * This is the shape used in application code - what developers interact with.
 */
export const simplifiedChapterObject = z.lazy(() => {
  return z.object({
    ...
    releaseDatePrecision: simplifiedChapterObjectReleaseDatePrecision,
...
/**
 * 
 * @typedef  {SimplifiedChapterObject} simplifiedChapterObject   
 ...
 * @property {SimplifiedChapterObjectReleaseDatePrecision} - The precision with which `release_date` value is known.

 * @property {ResumePointObject} 
 * @property {SimplifiedChapterObjectType} - The object type.
...
/**
 * Zod schema for mapping API responses to the SimplifiedChapterObject application shape.
 * Handles any property name transformations from the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const simplifiedChapterObjectResponse = z.lazy(() => {
  return z
    .object({
...
/**
 * Zod schema for mapping the SimplifiedChapterObject application shape to API requests.
 * Handles any property name transformations required by the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const simplifiedChapterObjectRequest = z.lazy(() => {
  return z
    .object({
      audioPreviewUrl: z.string().nullable(),
      availableMarkets: z.array(z.string()).optional(),
