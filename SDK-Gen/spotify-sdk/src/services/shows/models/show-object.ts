...
import { ShowObjectType, showObjectType } from './show-object-type';
import {
...
/**
 * Zod schema for the ShowObject model.
 * Defines the structure and validation rules for this data type.
 * This is the shape used in application code - what developers interact with.
 */
export const showObject = z.lazy(() => {
  return z.object({
 ...
 * @property {ShowObjectType} - The object type.
...
/**
 * Zod schema for mapping API responses to the ShowObject application shape.
 * Handles any property name transformations from the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const showObjectResponse = z.lazy(() => {
  return z
    .object({
      ...
      episodes: pagingSimplifiedEpisodeObjectResponse,
    })
    .transform((data) => ({
...
/**
 * Zod schema for mapping the ShowObject application shape to API requests.
 * Handles any property name transformations required by the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const showObjectRequest = z.lazy(() => {
  return z
    .object({
      availableMarkets: z.array(z.string()),
      ...
      uri: z.string(),
      totalEpisodes: z.number(),
      episodes: pagingSimplifiedEpisodeObjectRequest,
    })
    .transform((data) => ({
